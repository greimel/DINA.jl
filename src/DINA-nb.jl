...
# ╔═╡ e11ce75f-c4bc-4940-ba9e-6a876f9feb66
...
# ╔═╡ 62dd2c61-0956-4fd2-9c34-b85902b2dfdc
tbl = get_dina(1980)

# ╔═╡ d88fb4a2-ddbb-44a6-803d-0c8a93b74c07
df80 = DataFrame(tbl)

# ╔═╡ a5249aa6-f31f-42cc-928a-ec86fa125b31
(; df) = let
	inc = :peinc
	wgt = :dweght
	...
	df = dina_quantile_panel(var, byvar, 10, [1980])

	(; df)
end

# ╔═╡ cbbd7d1a-b045-4090-8288-de76108e4383
begin
	@chain df begin
		@transform(:h2y = :ownerhome / :peinc)
		data(_) * mapping(:group_id, :h2y, color = :age => nonnumeric) * visual(Lines)
		draw
	end
end
